This project has been created as part of the 42 curriculum by [YOUR_USERNAME].
...
YouTube: Support video 1

YouTube: Support video 2
...
* Bitwise logic: Theoretical validation of the >> (shift right) operator's functionality for the dynamic calculation of the maximum number of bits required by the Radix Sort algorithm.
